...
const DIFFICULTY_CURVES: Record<number, AnnouncementDistribution> = {
  // Token 1:  SAFE多, BAIT少, LOW中, MIDDLE少, HIGH多
  1: { SAFE: 2, BAIT: 1, LOW_RISK_REWARD: 2, MIDDLE_RISK_REWARD: 1, HIGH_RISK_REWARD: 2 },
  ...
  // Token 4: SAFE多, BAIT少, LOW中, MIDDLE少, HIGH少
  4: { SAFE: 2, BAIT: 1, LOW_RISK_REWARD: 2, MIDDLE_RISK_REWARD: 1, HIGH_RISK_REWARD: 1 },
  // Token 5+: SAFE多, BAIT少, LOW中, MIDDLE中, HIGH少
  5: { SAFE: 2, BAIT: 1, LOW_RISK_REWARD: 2, MIDDLE_RISK_REWARD: 2, HIGH_RISK_REWARD: 1 },
}
